...
format.foods(input_fn="data/RYGB/raw/RYGBLT_82285_Items.txt", output_fn="data/RYGB/dietrecords.txt", dedupe=F)
...
make.food.tree(nodes_fn="data/NodeLabelsMCT.txt", #the backbone to this whole thing
               food_database_fn="data/RYGB/ASA24Database.txt", #previously formatted above
...
make.dhydrt.otu(food_records_fn="data/RYGB/dietrecords.txt", food_record_id = "SampleID", food_taxonomy_fn="output/rygb.taxonomy.txt", 
