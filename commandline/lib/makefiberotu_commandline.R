option_list = list(
  make_option(c('-i', '--food_records_fn'),
              help = 'Required-foramtted file of all diet records, must contain FoodID and grams columns',
              default=NA, type='character'),
  make_option(c('-a', '--food_record_id'),
              help='Required- column name of identifier separating your diet records',
              default=NA, type='character'),
  make_option(c('-b', '--food_taxonomy_fn'),
              help = 'Required-taxonomy file generated by make.food.tree',
              default=NA, type='character'),
  make_optioin(c('-o', '--output_fn'),
               help = 'Required- output file name of your food otu table',
               default=NA, type='character')
)
